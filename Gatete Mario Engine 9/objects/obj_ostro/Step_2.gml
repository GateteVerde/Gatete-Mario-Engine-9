...
if (instance_exists(mytop)) {
    ...
    if ((isheavy < 2) && (!instance_exists(rider))) {
	...
	if (instance_exists(obj_mario)) {
		...
		&& ((instance_exists(rider)) && (!collision_rectangle(obj_mario.bbox_left, obj_mario.bbox_bottom-1, obj_mario.bbox_right, obj_mario.bbox_bottom+1, rider, 0, 0)))
