/// @description Lifted Gachapon Ball
			...
			if (yspeed > 0) {
				...
				#region
					...
					repeat (32) {
					    ...
					    with (instance_create_depth(x-8+random(24), y-16+random(8), -6, obj_gachapon_shard)) {
    
					        motion_set(random_range(60,120),random_range(4,6));
					        if (choose(0,1) == 0)
					            sprite_index = spr_gachapon_shard_top_h;
					    }
					}

					//Create bottom part
					with (instance_create_depth(x+8, y+8, -6, obj_gachapon_shard_bottom)) {
