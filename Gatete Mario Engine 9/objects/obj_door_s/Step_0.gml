	...
	&& (!instance_exists(obj_mario_transform)) {
        ...
        && (mario.state != playerstate.climb) {
			...
			if (boo == true) {
				...
				//Create smoke
				with (instance_create_depth(x + 8, y + 8, -2, obj_smoke)) {
				...
				//Create boos
				with (instance_create_depth(x + 8, y, -4, obj_door_boo)) motion_set(45, 1.5);
				with (instance_create_depth(x + 8, y, -4, obj_door_boo)) motion_set(135, 1.5);
				with (instance_create_depth(x + 8, y, -4, obj_door_boo)) motion_set(225, 1.5);
				with (instance_create_depth(x + 8, y, -4, obj_door_boo)) motion_set(315, 1.5);
